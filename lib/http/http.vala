...
public class Request : Object {
  ...
  private Request(string url, string method, HashTable<string, string>? headers = null) {
    this.url = url;
    this.method = method;
    this.session = new Soup.Session ();
    this.msg = new Soup.Message (method.up (), url);
  ...
  /**
   * @param url The URL to make the request to
   * @param headers A HashTable of headers
   * @param body Request body
   */
  public Request.post(string url, HashTable<string, string>? headers = null, RequestBody? body = null) {
    /* this.url = url;
    this.method = "POST";
    this.session = new Soup.Session ();
    this.msg = new Soup.Message (this.method, url); */
   ...
   * @param headers A HashTable of headers
   */
  public Request.get(string url, HashTable<string, string>? headers = null) {
    this(url, "get", headers);
  }
...
public class RequestBody {
   ...
   */
  public RequestBody(Bytes bytes, string? content_type = null) {
    this.bytes = bytes;
   ...
   */
  public RequestBody.with_json_string(string body) {
